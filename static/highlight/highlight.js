...
;r.contains=[o,c,s,e.APOS_STRING_MODE,e.QUOTE_STRING_MODE,i,e.C_BLOCK_COMMENT_MODE],
    ...
    name:"PHP template",subLanguage:"xml",contains:[{begin:/<\?(php|=)?/,end:/\?>/,
        subLanguage:"php",contains:[{begin:"/\\*",end:"\\*/",skip:!0},{begin:'b"',
            ...
            skip:!0})]}]})})());hljs.registerLanguage("go",(()=>{"use strict";return e=>{const n={
...
;return s.contains=s.contains.concat(t),c.contains=c.contains.concat(t),
    ...
    const n=/[a-zA-Z@][a-zA-Z0-9_]*/,_={$pattern:n,
        ...
        keywords:{$pattern:n,
            ...
            begin:"\\."+e.UNDERSCORE_IDENT_RE,relevance:0}]}}})());hljs.registerLanguage("c",(()=>{"use strict";function e(e){
...
;return n.disableAutodetect=!1,n.name="C++",
    ...
    const t="\\[=*\\[",a="\\]=*\\]",n={begin:t,end:a,contains:["self"]
        ...
        relevance:10})];return{name:"Lua",keywords:{$pattern:e.UNDERSCORE_IDENT_RE,
            ...
            begin:t,end:a,contains:[n],relevance:5}])}}})());hljs.registerLanguage("diff",(()=>{"use strict";return e=>({name:"Diff",
